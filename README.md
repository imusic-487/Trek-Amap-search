...
唯一要求是一个免费的高德 Web 服务 API Key（[console.amap.com](https://console.amap.com/)）。免费（每天 50 万次调用）——注册可能需要中国手机号，但拿到 Key 之后，搜中国地点比只用 OSM 容易太多了。
